...
import com.example.movieScreen.presentation.widget.collapsingTopBar.BackdropContent
import com.example.movieScreen.presentation.widget.collapsingTopBar.CollapsedTopBar
import com.example.movieScreen.presentation.widget.collapsingTopBar.ExpandedContent
import com.example.movieScreen.presentation.widget.itemContent.collectionsItem
import com.example.movieScreen.presentation.widget.itemContent.commentsItem
import com.example.movieScreen.presentation.widget.itemContent.factsItem
import com.example.movieScreen.presentation.widget.itemContent.imagesItem
import com.example.movieScreen.presentation.widget.itemContent.movieDescriptionItem
import com.example.movieScreen.presentation.widget.itemContent.personGridHorizontalItem
import com.example.movieScreen.presentation.widget.itemContent.premierItem
import com.example.movieScreen.presentation.widget.itemContent.ratingCardLargeItem
import com.example.movieScreen.presentation.widget.itemContent.seasonDescriptionItem
import com.example.movieScreen.presentation.widget.itemContent.similarMoviesItem
import com.example.movieScreen.presentation.widget.itemContent.supportPersonalItem
import com.example.movieScreen.presentation.widget.itemContent.voiceActorsItem
import com.example.movieScreen.presentation.widget.itemContent.watchabilityItem
